...
for i in range(66):
    ...
    with open(f"generated/bereaninterlinear{needed_book}.go", "w") as output_file:
        output_file.write("package base\n\n")
        output_file.write(f"func GetBereanInterlinear{needed_book}() map[string]VerseType {'{'}\n")
